    ...
    <div class="bt">
      <form @submit.prevent="upload" method="post" enctype="multipart/form-data">
        ...
        <div class="bt1-wrapper">
          <button type="submit" class="bt1">上传视频</button>
        </div>
      </form>
    </div>
    <div class="font-wrapper">
      <a href="/" class="goto">图片校准</a>
...
export default {
  ...
  methods: {
    ...
    upload: function () {
      if (this.filename === '视频二' || this.morename === '视频一') {
        Toast('请选视频')
        return
      }
      this.loding()
      ...
      this.$http.post('http://127.0.0.1:8000/web/upload/getuploadvideo/', formData, {
